...
wholeDeviceUnitFile+="offlineLog <-   hardware.uart57;\n"
...
wholeDeviceUnitFile+="    offlineLog.flush()\n" 
...
for letter in deviceText:
    ...
    if(letter=="\n"):
        ...
        wholeLine=wholeLine.replace("hardware.pin5.configure(DIGITAL_OUT)","//hardware.pin5.configure(DIGITAL_OUT)")
